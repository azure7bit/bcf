...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email: @visitor.email, message: @visitor.message, name: @visitor.name, subject: @visitor.subject }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { email: @visitor.email, message: @visitor.message, name: @visitor.name, subject: @visitor.subject }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
